package com.marottileandro.cannongame;
...
public class CannonView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public static final double TARGET_SPACING_PERCENT = 3.0 / 60;
    ...
    //variables for the game loop and trackling statistics
    ...
    public CannonView(Context context, AttributeSet attrs) {
        ...
        soundMap.put(TARGET_SOUND_ID, soundPool.load(context, R.raw.hit_target, 1));
        soundMap.put(CANNON_SOUND_ID, soundPool.load(context, R.raw.fire_cannon, 1));
        soundMap.put(BLOCKER_SOUND_ID, soundPool.load(context, R.raw.blocker, 1));
    ...
    public void newGame() {
        ...
        for (int n = 0; n < TARGET_PIECES; n++){
            ...
            int color = (n % 2 == 0) ? getResources().getColor(R.color.dark,
                    getContext().getTheme()) : getResources().getColor(R.color.light, getContext().getTheme());
    ...
    private void updatePositions(double elapsedTimeMS) {
        ...
        // update cannonball's positions if it is on the screen
        ...
        if (targets.isEmpty()) {
            cannonThread.setRunning(false); // terminate thread
            showGameOverDialog(R.string.win); // show the winning dialog
            gameOver = true;
        }
    }
    ...
    public void alignAndFireCannonball(MotionEvent event) {
        ...
        double angle; // initialize angle to 0
    ...
    public void drawGameElements(Canvas canvas) {
        ...
        canvas.drawText(getResources().getString(R.string.time_remaining_format,
                timeLeft), 50, 100, textPaint);
    ...
    public void testForCollisions() {
        // remove any of the targets that Cannonball collides with
        ...
        else { //remove cannonball if it should not be on the screen
        ...
        public void run() {
            ...
            while (threadIsRunning) {
                try{
                    ...
                    // display canva's contents on the cannonView and enable
                    // other threads to use the canvas
                    if (canvas != null)
